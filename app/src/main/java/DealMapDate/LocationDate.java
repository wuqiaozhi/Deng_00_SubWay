...
public class LocationDate {
     ...
     * 构造方法
     */
    public LocationDate(Context context,AMapLocationListener locationListener){
    ...
    public   String getCityLocation(AMapLocation location) {
        if (null == location) {
            return null;
        }
